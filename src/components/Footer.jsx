    ...
    return (
        ...
        <div className='container d-flex flex-column flex-lg-row  justify-content-between align-items-center align-items-lg-start'>
            <div className='col-6'>
                ...
                <p>Villares Auto Partes - Sua Fonte Confiável para Peças Automotivas Inovadoras e Sustentáveis. Há mais de duas décadas, reinventamos o desmanche, proporcionando soluções acessíveis e ecológicas para veículos nacionais e importados. Junte-se a nós , onde tradição encontra inovação, e a qualidade preserva a performance do seu carro.</p>
            </div>
