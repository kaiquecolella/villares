      ...
      <main>
        ...
        <section id='scrollspy-About' className='pt-5 pb-5 bgDark '>
          <article className='container d-flex flex-column gap-3'>
            <h2 className='mt-5'>Tecnologia, Tradição e Confiança:<br />A Jornada de Qualidade da villares auto parts ao Longo de Duas Décadas</h2>
            <p>Há mais de duas décadas, a villares auto parts tem sido líder no mercado automotivo, oferecendo soluções inovadoras e confiáveis em peças para veículos nacionais e importados. Nosso compromisso com a excelência e a sustentabilidade molda nossa jornada como um desmanche pioneiro. Com uma rica tradição de mais de 20 anos, continuamos a redefinir padrões, proporcionando aos nossos clientes uma experiência única e acessível.</p>
            <p>Na villares auto parts, a qualidade é nossa prioridade. Selecionamos cuidadosamente peças de sucata, mantendo elevados padrões de inspeção para garantir que cada componente atenda ou supere as expectativas dos produtos originais/novos. Nosso serviço de desmanche inteligente é a fusão perfeita entre economia e qualidade, proporcionando aos nossos clientes a confiança de dirigir com peças confiáveis e sustentáveis.</p>
            <p>Ao longo dos anos, construímos uma reputação sólida baseada na integridade, na transparência e na dedicação ao cliente. A villares auto parts é mais do que uma empresa; é uma comunidade comprometida em simplificar a manutenção veicular e preservar a qualidade do seu automóvel. Junte-se a nós nessa jornada automotiva, onde a tradição encontra a inovação, e a confiança encontra a sustentabilidade.</p>
          </article>
        </section>
